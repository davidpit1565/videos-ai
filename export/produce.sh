...
#
#   ./export/produce.sh <episode> <build.html> <duration> [accept_words]
#
...
")
echo "=== [6/8] music bed at ${NEWDUR}s"
python3 audio/build_music.py "$NEWDUR" "$MUSIC" || exit 1
