...
2. "Microsoft's own privacy page is direct about it — your prompts and its reply get saved as your activity history." (rewrote "says it plainly ... its answers" → "is direct about it ... its reply": "plainly" is a flagged -LY, "answers" a flagged R+cluster)
3. "Your company's own IT side can keep that same copy for up to a year — sometimes even more, depending on what they've set." (rewrote "sometimes longer" → "sometimes even more": "longer" is a flagged unstressed -ER)
4. "It's not every boss. Reading the actual chat needs a specific compliance permission, not just being an admin." (rewrote "manager" → "boss": flagged unstressed -ER)
5. "You can check your own copy right now — Microsoft account, Privacy, Copilot activity history."
