...
- **Brainstorm new ideas** using `brainstorming-research-ideas`, `creative-thinking-for-research` skills when you're stuck or when results open unexpected questions
...
3. **Form initial hypotheses** — invoke `brainstorming-research-ideas`, `creative-thinking-for-research` skills
...
6. Generate new hypotheses if warranted (invoke `brainstorming-research-ideas`, `creative-thinking-for-research` skills)
...
Don't keep trying random changes. Step back: search literature for related work, invoke `brainstorming-research-ideas`, `creative-thinking-for-research` brainstorming skills, or run an outer loop reflection. Being stuck means you need new information or a new perspective, not more experiments.
