  ...
  return {
    ...
    episodes: [
      ep(1, "Paste this once — the Universal AI Engine", "both", "testing",
         "ChatGPT · Custom Instructions", "קול משוכפל מוכן · מחכה לאישור"),
      ep(2, "What an AI agent actually is", "both", "idea",
         "Agents · יסודות", "שער הכניסה לסדרת הסוכנים"),
      ep(3, "I gave an agent my inbox for a week", "both", "idea",
         "Lindy / ChatGPT Agent", "פורמט תוצאות — הצפייה הארוכה ביותר"),
      ep(4, "Your first n8n agent: email → summary → Telegram", "long", "idea",
         "n8n", "הכלי המבוקש ביותר · בנייה מקצה לקצה"),
      ep(5, "The 5 things agents still can't do", "both", "idea",
         "Agents · מגבלות", "סרטון החתימה"),
    ],
    snapshots: [{
    ...
    ideas: [
      ...
      { id: uid(), text: "Claude Code למי שלא מתכנת" },
