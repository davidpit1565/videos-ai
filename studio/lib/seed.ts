  ...
  return {
    ...
    episodes: [
      ...
      ep(3, "Your first n8n agent: email → summary → Telegram", "long", "idea",
         "n8n", "ביקוש: חציון 233 אלף — הגבוה במדידה · הריל הארוך והמלא"),
      ep(4, "The AI setup I'd sell to a business", "both", "idea",
         "Agents · לעסקים", "המילה sell הופיעה פי 5 ברביע העליון · הריל שמביא פניות"),
      ...
      ep(6, "The 5 things agents still can't do", "both", "idea",
         "Agents · מגבלות", "ריל חתימה · מבדל ממי שמבטיח הכל"),
    ],
    snapshots: [{
    ...
    revenue: [
      ...
      { id: uid(), name: "ניוזלטר — ספונסרים", status: "idea", mrrEur: 0,
        needsAudience: "~5,000 נרשמים", nextStep: "לפרסם את הריל הראשון" },
