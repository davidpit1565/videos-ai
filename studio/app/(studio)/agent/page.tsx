...
const PRESETS = [
  "מה הריל הבא שכדאי לי לעשות, ולמה?",
...
export default function AgentPage() {
  ...
  return (
    <>
      ...
      <p className="sub">
        הסוכן רואה בדיוק את מה שיש במערכת — רילים, מדדים, תמונות צמיחה, מקורות הכנסה ומשימות
      ...
      {!answer && !err && !busy && (
        <div className="note">
          ...
          כרגע אין עדיין ריל באוויר, ולכן על שאלות שתלויות במדדים התשובה הנכונה היא &quot;אין מספיק
